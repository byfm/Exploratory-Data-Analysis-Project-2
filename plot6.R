# Use Readdata.R prior to that script

# Loading provided datasets - loading local data
...
ggplot(data=DF, aes(x=year, y=Emissions)) + geom_bar(stat="identity", aes(fill=year)) + 
    guides(fill=F) + 
